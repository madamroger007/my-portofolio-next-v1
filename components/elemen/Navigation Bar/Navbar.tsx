    ...
    <div className="fixed z-50 navbar backdrop-blur-3xl " suppressHydrationWarning={true}>
      <div className="navbar-start  ">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu gap-2 menu-sm dropdown-content mt-3 z-[1] p-2 shadow rounded-box w-52 dark:bg-black bg-white">
            ...
            <ButtonPrimary className='px-5 max-md:mt-5'>Download CV</ButtonPrimary>
          </ul>
