...
const BgHeroSection = () => {
    return (
        <div className='grid lg:grid-cols-3 grid-cols-1 w-full '>
            <div className="w-full px-5 grid gap-5 max-md:gap-10 justify-center ">
                <div>
            ...
            <div className="w-full">
                <div className='flex justify-center  max-lg:pt-10'>
                    <h2 className='font-poppins text-center dark:text-gray-300 text-gray-700'>I am an app developer, marketing and designer</h2>
                </div>
